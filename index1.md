...
（文章后期补充）后来我简单试了一下SVM，对验证集的准确率竟然是89%！！滴血滴血~~！![Mou icon](https://raw.githubusercontent.com/jayliangdl/jayliangdl.github.io/master/han.png)枉费我上面处理了这么一大段~！！！本来以为算法之间差距很小，集种精力在对数据进行预处理上。看来是错的！在不同场景和案例下不同算法还是有一定差别的。下次可以提早试试。
